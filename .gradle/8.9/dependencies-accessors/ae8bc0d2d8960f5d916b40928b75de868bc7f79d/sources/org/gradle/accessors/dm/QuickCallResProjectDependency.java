...
@NonNullApi
public class QuickCallResProjectDependency extends DelegatingProjectDependency {

    @Inject
    public QuickCallResProjectDependency(TypeSafeProjectDependencyFactory factory, ProjectDependencyInternal delegate) {
