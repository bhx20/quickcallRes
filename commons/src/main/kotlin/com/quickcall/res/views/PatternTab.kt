...
import com.quickcall.res.databinding.TabPatternBinding
import com.quickcall.res.extensions.getProperPrimaryColor
import com.quickcall.res.extensions.getProperTextColor
import com.quickcall.res.extensions.performHapticFeedback
import com.quickcall.res.extensions.updateTextColors
import com.quickcall.res.helpers.PROTECTION_PATTERN
import com.quickcall.res.interfaces.BaseSecurityTab
...
class PatternTab(context: Context, attrs: AttributeSet) : BaseSecurityTab(context, attrs) {
    ...
    override fun initTab(
        ...
        if (computedHash != "") binding.patternLockTitle.setText(com.quickcall.strings.R.string.enter_pattern)
    }
