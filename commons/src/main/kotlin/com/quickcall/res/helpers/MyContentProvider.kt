...
object MyContentProvider {
    private const val AUTHORITY = "com.quickcall.res.provider"
    val MY_CONTENT_URI: Uri = Uri.parse("content://$AUTHORITY/settings")

    const val ACTION_GLOBAL_CONFIG_UPDATED = "com.quickcall.android.GLOBAL_CONFIG_UPDATED"
    const val PERMISSION_WRITE_GLOBAL_SETTINGS = "com.quickcall.android.permission.WRITE_GLOBAL_SETTINGS"

    const val COL_ID = "_id"    // used in Thank You
