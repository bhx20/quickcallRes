...
import com.quickcall.res.extensions.getIntValue
import com.quickcall.res.extensions.getStringValue
import com.quickcall.res.models.PhoneNumber
import com.quickcall.res.models.SimpleContact
import com.quickcall.res.models.contacts.*
...
class MyContactsContentProvider {
    companion object {
        private const val AUTHORITY = "com.quickcall.res.contactsprovider"
        ...
        fun getSimpleContacts(context: Context, cursor: Cursor?): ArrayList<SimpleContact> {
            ...
            if (packageName != "com.quickcall.dialer" && packageName != "com.quickcall.smsmessenger" && packageName != "com.quickcall.calendar") {
                return contacts
            }
        ...
        fun getContacts(context: Context, cursor: Cursor?): ArrayList<Contact> {
            ...
            val packageName = context.packageName.removeSuffix(".debug")
            if (packageName != "com.quickcall.dialer" && packageName != "com.quickcall.smsmessenger" && packageName != "com.quickcall.calendar"
                && packageName != "com.quickcall.dialer.debug" && packageName != "com.quickcall.smsmessenger.debug" && packageName != "com.quickcall.calendar.debug") {
                return contacts
            }
