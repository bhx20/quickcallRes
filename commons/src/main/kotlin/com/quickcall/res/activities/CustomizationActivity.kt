...
import com.quickcall.res.databinding.ActivityCustomizationBinding
import com.quickcall.res.dialogs.*
import com.quickcall.res.extensions.*
import com.quickcall.res.helpers.*
import com.quickcall.res.helpers.MyContentProvider.COL_ACCENT_COLOR
import com.quickcall.res.helpers.MyContentProvider.COL_APP_ICON_COLOR
import com.quickcall.res.helpers.MyContentProvider.COL_BACKGROUND_COLOR
import com.quickcall.res.helpers.MyContentProvider.COL_PRIMARY_COLOR
import com.quickcall.res.helpers.MyContentProvider.COL_TEXT_COLOR
import com.quickcall.res.helpers.MyContentProvider.COL_THEME_TYPE
import com.quickcall.res.helpers.MyContentProvider.GLOBAL_THEME_CUSTOM
import com.quickcall.res.helpers.MyContentProvider.GLOBAL_THEME_DISABLED
import com.quickcall.res.helpers.MyContentProvider.GLOBAL_THEME_SYSTEM
import com.quickcall.res.models.GlobalConfig
import com.quickcall.res.models.MyTheme
import com.quickcall.res.models.RadioItem
import com.quickcall.res.models.isGlobalThemingEnabled
...
//        binding.applyToAll.setTextColor(primaryColor.getContrastColor())
        ...
        binding.customizationAppIconColorHolder.setOnClickListener {
            if (baseConfig.wasAppIconCustomizationWarningShown || !isProVersion()) {
                ...
                ConfirmationDialog(this, "", com.quickcall.strings.R.string.app_icon_color_warning_g, R.string.ok, 0) {
    ...
    private fun pickPrimaryColor() {
        if (!packageName.startsWith("com.quickcall.", true) && baseConfig.appRunCount > 50) {
            finish()
            return
        }
    ...
    private fun pickAppIconColor() {
        IconListDialog(
            ...
            descriptionId = com.quickcall.strings.R.string.app_icon_color_warning_g
    ...
    private fun applyToAll() {
        when {
            ...
            isPro() -> {
                ...
                ConfirmationDialog(this, "", com.quickcall.strings.R.string.global_theme_success_g, R.string.ok, 0) {
                    updateColorTheme(getCurrentThemeId())
                    saveChanges(false)
                }
            }
    ...
    private fun setupUseAccentColor() {
        binding.apply {
            ...
            customizationUseAccentColorFaq.setOnClickListener {
                ConfirmationDialog(this@CustomizationActivity, messageId = com.quickcall.strings.R.string.use_accent_color_summary, positive = com.quickcall.res.R.string.ok, negative = 0) {}
            }
        }
    }
