...
import com.quickcall.res.compose.extensions.onEventValue
import com.quickcall.res.compose.screens.ManageBlockedNumbersScreen
import com.quickcall.res.compose.theme.AppThemeSurface
import com.quickcall.res.dialogs.AddOrEditBlockedNumberAlertDialog
import com.quickcall.res.dialogs.ExportBlockedNumbersDialog
...
class ManageBlockedNumbersActivity : BaseSimpleActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            val isDialer = remember {
                config.appId.startsWith("com.quickcall.dialer")
            }
    ...
    private fun maybeSetDefaultCallerIdApp() {
        if (isQPlus() && baseConfig.appId.startsWith("com.quickcall.dialer")) {
