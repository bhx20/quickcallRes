...
import com.quickcall.res.databinding.DialogTitleBinding
import com.quickcall.res.dialogs.*
import com.quickcall.res.dialogs.WritePermissionDialog.WritePermissionDialogMode
import com.quickcall.res.helpers.*
import com.quickcall.res.helpers.MyContentProvider.COL_LAST_UPDATED_TS
import com.quickcall.res.helpers.MyContentProvider.MY_CONTENT_URI
import com.quickcall.res.models.*
...
fun Activity.openPathIntent(
    ...
    ensureBackgroundThread {
        ...
        Intent().apply {
            ...
            if (applicationId == "com.quickcall.gallery" || applicationId == "com.quickcall.gallery.debug") {
...
fun BaseSimpleActivity.launchCallIntent(recipient: String, handle: PhoneAccountHandle? = null, key: String = "") {
    handlePermission(PERMISSION_CALL_PHONE) {
        ...
        Intent(action).apply {
            ...
            if (isDefaultDialer()) {
                val packageName = if (baseConfig.appId.contains(".debug", true)) "com.quickcall.dialer.debug" else "com.quickcall.dialer"
                val className = "com.quickcall.dialer.activities.DialerActivity"
