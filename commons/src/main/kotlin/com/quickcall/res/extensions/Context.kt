...
import com.quickcall.res.helpers.MyContentProvider.PERMISSION_WRITE_GLOBAL_SETTINGS
import com.quickcall.res.models.AlarmSound
import com.quickcall.res.models.BlockedNumber
import com.quickcall.res.models.contacts.ContactRelation
import com.quickcall.strings.R as stringsR
...
fun Context.getFilePublicUri(file: File, applicationId: String): Uri {
    ...
    // if media content uri is null, get our custom uri like content://com.quickcall.gallery.provider/external_files/emulated/0/DCIM/IMG_20171104_233915.jpg
...
fun Context.isOrWasThankYouInstalled(): Boolean {
    return when {
        ...
        isPackageInstalled("com.quickcall.audiobook") -> true
        isPackageInstalled("com.quickcall.voicerecorder") -> true
        isPackageInstalled("com.quickcall.files") -> true
        else -> false
    }
}
...
fun Context.getCanAppBeUpgraded() = proPackages.contains(baseConfig.appId.removeSuffix(".debug").removePrefix("com.quickcall."))
...
fun Context.getRelationTypeText(type: Int, label: String): String {
    return if (type == BaseTypes.TYPE_CUSTOM) {
        ...
        getString(
            when (type) {
                // Relation.TYPE_CUSTOM   -> com.quickcall.strings.R.string.custom
                Relation.TYPE_ASSISTANT   -> com.quickcall.strings.R.string.relation_assistant_g
                Relation.TYPE_BROTHER     -> com.quickcall.strings.R.string.relation_brother_g
                Relation.TYPE_CHILD       -> com.quickcall.strings.R.string.relation_child_g
                Relation.TYPE_DOMESTIC_PARTNER -> com.quickcall.strings.R.string.relation_domestic_partner_g
                Relation.TYPE_FATHER      -> com.quickcall.strings.R.string.relation_father_g
                Relation.TYPE_FRIEND      -> com.quickcall.strings.R.string.relation_friend_g
                Relation.TYPE_MANAGER     -> com.quickcall.strings.R.string.relation_manager_g
                Relation.TYPE_MOTHER      -> com.quickcall.strings.R.string.relation_mother_g
                Relation.TYPE_PARENT      -> com.quickcall.strings.R.string.relation_parent_g
                Relation.TYPE_PARTNER     -> com.quickcall.strings.R.string.relation_partner_g
                Relation.TYPE_REFERRED_BY -> com.quickcall.strings.R.string.relation_referred_by_g
                Relation.TYPE_RELATIVE    -> com.quickcall.strings.R.string.relation_relative_g
                Relation.TYPE_SISTER      -> com.quickcall.strings.R.string.relation_sister_g
                Relation.TYPE_SPOUSE      -> com.quickcall.strings.R.string.relation_spouse_g

                // Relation types defined in vCard 4.0
                ContactRelation.TYPE_CONTACT -> com.quickcall.strings.R.string.relation_contact_g
                ContactRelation.TYPE_ACQUAINTANCE -> com.quickcall.strings.R.string.relation_acquaintance_g
                // ContactRelation.TYPE_FRIEND -> com.quickcall.strings.R.string.relation_friend
                ContactRelation.TYPE_MET -> com.quickcall.strings.R.string.relation_met_g
                ContactRelation.TYPE_CO_WORKER -> com.quickcall.strings.R.string.relation_co_worker_g
                ContactRelation.TYPE_COLLEAGUE -> com.quickcall.strings.R.string.relation_colleague_g
                ContactRelation.TYPE_CO_RESIDENT -> com.quickcall.strings.R.string.relation_co_resident_g
                ContactRelation.TYPE_NEIGHBOR -> com.quickcall.strings.R.string.relation_neighbor_g
                // ContactRelation.TYPE_CHILD -> com.quickcall.strings.R.string.relation_child
                // ContactRelation.TYPE_PARENT -> com.quickcall.strings.R.string.relation_parent
                ContactRelation.TYPE_SIBLING -> com.quickcall.strings.R.string.relation_sibling_g
                // ContactRelation.TYPE_SPOUSE -> com.quickcall.strings.R.string.relation_spouse
                ContactRelation.TYPE_KIN -> com.quickcall.strings.R.string.relation_kin_g
                ContactRelation.TYPE_MUSE -> com.quickcall.strings.R.string.relation_muse_g
                ContactRelation.TYPE_CRUSH -> com.quickcall.strings.R.string.relation_crush_g
                ContactRelation.TYPE_DATE -> com.quickcall.strings.R.string.relation_date_g
                ContactRelation.TYPE_SWEETHEART -> com.quickcall.strings.R.string.relation_sweetheart_g
                ContactRelation.TYPE_ME -> com.quickcall.strings.R.string.relation_me_g
                ContactRelation.TYPE_AGENT -> com.quickcall.strings.R.string.relation_agent_g
                ContactRelation.TYPE_EMERGENCY -> com.quickcall.strings.R.string.relation_emergency_g

                ContactRelation.TYPE_SUPERIOR -> com.quickcall.strings.R.string.relation_superior_g
                ContactRelation.TYPE_SUBORDINATE -> com.quickcall.strings.R.string.relation_subordinate_g
                ContactRelation.TYPE_HUSBAND -> com.quickcall.strings.R.string.relation_husband_g
                ContactRelation.TYPE_WIFE -> com.quickcall.strings.R.string.relation_wife_g
                ContactRelation.TYPE_SON -> com.quickcall.strings.R.string.relation_son_g
                ContactRelation.TYPE_DAUGHTER -> com.quickcall.strings.R.string.relation_daughter_g
                ContactRelation.TYPE_GRANDPARENT -> com.quickcall.strings.R.string.relation_grandparent_g
                ContactRelation.TYPE_GRANDFATHER -> com.quickcall.strings.R.string.relation_grandfather_g
                ContactRelation.TYPE_GRANDMOTHER -> com.quickcall.strings.R.string.relation_grandmother_g
                ContactRelation.TYPE_GRANDCHILD -> com.quickcall.strings.R.string.relation_grandchild_g
                ContactRelation.TYPE_GRANDSON -> com.quickcall.strings.R.string.relation_grandson_g
                ContactRelation.TYPE_GRANDDAUGHTER -> com.quickcall.strings.R.string.relation_granddaughter_g
                ContactRelation.TYPE_UNCLE -> com.quickcall.strings.R.string.relation_uncle_g
                ContactRelation.TYPE_AUNT -> com.quickcall.strings.R.string.relation_aunt_g
                ContactRelation.TYPE_NEPHEW -> com.quickcall.strings.R.string.relation_nephew_g
                ContactRelation.TYPE_NIECE -> com.quickcall.strings.R.string.relation_niece_g
                ContactRelation.TYPE_FATHER_IN_LAW -> com.quickcall.strings.R.string.relation_father_in_law_g
                ContactRelation.TYPE_MOTHER_IN_LAW -> com.quickcall.strings.R.string.relation_mother_in_law_g
                ContactRelation.TYPE_SON_IN_LAW -> com.quickcall.strings.R.string.relation_son_in_law_g
                ContactRelation.TYPE_DAUGHTER_IN_LAW -> com.quickcall.strings.R.string.relation_daughter_in_law_g
                ContactRelation.TYPE_BROTHER_IN_LAW -> com.quickcall.strings.R.string.relation_brother_in_law_g
                ContactRelation.TYPE_SISTER_IN_LAW -> com.quickcall.strings.R.string.relation_sister_in_law_g
...
fun Context.isCollection(): Boolean {
    return isPackageInstalled("com.quickcall.dialer")
        && isPackageInstalled("com.quickcall.contacts")
        && isPackageInstalled("com.quickcall.smsmessenger")
        && isPackageInstalled("com.quickcall.gallery")
        && isPackageInstalled("com.quickcall.audiobooklite")
        && isPackageInstalled("com.quickcall.filemanager")
        && isPackageInstalled("com.quickcall.keyboard")
        && isPackageInstalled("com.quickcall.calendar")
}
